...
class GetUserPersonalChatMessages:
    async def get_user_personal_chat_messages(
        ...
        """Use this method to get the last ``limit`` messages from the personal chat (i.e., the chat currently added to their profile) of a given user.
        ...
        Parameters:
            ...
            limit (``int``, *optional*):
                ...
                By default, no limit is applied and the last 20 messages are returned.
    ...
    async def get_user_personal_chat_messages_count(
        self: "pyrogram.Client",
        user_id: Union[int, str],
    ) -> Optional[int]:
        ...
        return getattr(history, "count", len(history.messages))

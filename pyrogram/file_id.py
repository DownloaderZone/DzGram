...
class FileType(IntEnum):
    ...
    WALLPAPER = 12
    VIDEO_NOTE = 13
    SECURE_RAW = 14  # SecureDecrypted
    SECURE = 15  # SecureEncrypted
    BACKGROUND = 16
    DOCUMENT_AS_FILE = 17
    RINGTONE = 18
    CALL_LOG = 19
    PHOTO_STORY = 20
    VIDEO_STORY = 21
    SELF_DESTRUCTING_PHOTO = 22
    SELF_DESTRUCTING_VIDEO = 23
    SELF_DESTRUCTING_VIDEO_NOTE = 24
    SELF_DESTRUCTING_VOICE_NOTE = 25
    LIVE_PHOTO = 26
    SELF_DESTRUCTING_LIVE_PHOTO = 27
    SIZE = 28
    NONE = 29

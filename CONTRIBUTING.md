# Contributing to this DzGram Fork

Welcome, and thank you for your interest in contributing to this DzGram Fork!
...
If you’re unsure whether your changes are welcome, open an issue on GitHub or preferably ask in the [Telegram chat](https://t.me/dzgram).

In case you’d like to get some inspiration what we're working on, we have a [long list of issues across all repositories](https://github.com/DownloaderZone/DzGram/issues) and there is usually also a [pinned issue](https://github.com/DownloaderZone/DzGram/issues) which tells you which issues need help.

## Asking Questions

If you have a question, please use the [Telegram Chat](https://t.me/dzgram) instead of opening an issue. Simply start a message in the correct topic and our community will gladly answer.

## Providing Feedback

Feedback from the community is very important to us as the maintainers of this DzGram fork. If you have any suggestions, ideas, or concerns, please share them with us. You can use the [Telegram Chat](https://t.me/dzgram) to start a conversation.
...
Have you identified a reproducible problem in this DzGram fork? Do you have a feature request? Here is how you can report your issue as efficiently as possible.
...
- The version of DzGram and the operating system you are using. Kindly refrain from reporting issues noticed incase you are unable to reproduce it consistently with this DzGram fork.
...
To contribute code to this DzGram fork, simply open a pull request by following the guide below.
...
1. Fork this DzGram repository to your GitHub account.
2. Clone your forked repository of DzGram to your computer:

```bash
git clone https://github.com/DownloaderZone/DzGram
cd DzGram
```
...
```bash
git remote add upstream https://github.com/DownloaderZone/DzGram
```
...
We use Sphinx to generate documentation in the [docs](https://github.com/DownloaderZone/DzGram) repository. You can edit the sources and preview the changes using a live-preview server with:
